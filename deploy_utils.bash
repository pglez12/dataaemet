...
SERVICE_NAME=aemet-service
PROJECT_ID='data-aemet'
...
SERVICE_ACCOUNT=aemet-service-account
SCHEDULER_SERVICE_ACCOUNT=scheduler-service-account
PORT=8000
PUBSUB_TOPIC=aemet-topic
PUBSUB_SUBSCRIPTION=aemet-subscription
...
function create_etl_service_account(){
    ...
    gcloud iam service-accounts create ${SERVICE_ACCOUNT} \
        --display-name="AEMET Service Account" \
        --project=${PROJECT_ID}
